...
var indexNav = [
    ...
    {
        name: '网点信息',
        url: './pages/wangdian/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/lenglianwuliuxitong/admin/dist/index.html#/login";
